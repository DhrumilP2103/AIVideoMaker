...
public let ReachabilityStatusChangedNotification =
...
open class LetsReach {
    ...
    open func monitorReachabilityChanges() {
            ...
            { (_, flags, _) in
                ...
                NotificationCenter.default.post(
                    name: NSNotification.Name(
                        rawValue: ReachabilityStatusChangedNotification),
                    object: nil,
        ...
        SCNetworkReachabilityScheduleWithRunLoop(
            reachability, CFRunLoopGetMain(), CFRunLoopMode.commonModes.rawValue
        )
    }
